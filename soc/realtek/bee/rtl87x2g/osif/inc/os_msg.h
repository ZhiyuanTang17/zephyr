...
extern bool (*os_msg_queue_peek_intern)(void *p_handle, uint32_t *p_msg_num, const char *p_func,
					uint32_t file_line);

extern bool (*os_msg_send_intern)(void *p_handle, void *p_msg, uint32_t wait_ms, const char *p_func,
				  uint32_t file_line);

extern bool (*os_msg_recv_intern)(void *p_handle, void *p_msg, uint32_t wait_ms, const char *p_func,
				  uint32_t file_line);

extern bool (*os_msg_peek_intern)(void *p_handle, void *p_msg, uint32_t wait_ms, const char *p_func,
				  uint32_t file_line);
 ...
 *     if (os_msg_queue_create(&p_handle, "msg queue name", MSG_NUM, sizeof(struct test_msg)) ==
 * true)
 *     {
 ...
 *
 */
#define os_msg_queue_delete(p_handle) os_msg_queue_delete_intern(p_handle, __func__, __LINE__)
