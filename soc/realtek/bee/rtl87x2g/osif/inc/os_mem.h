...
extern void *(*os_mem_zalloc_intern)(RAM_TYPE ram_type, size_t size, const char *p_func,
				     uint32_t file_line);
 ...
 *
 */
#define os_mem_alloc2(size) os_mem_alloc_intern(RAM_TYPE_DATA_ON, size, __func__, __LINE__)
 ...
 *
 */
#define os_mem_zalloc(ram_type, size) os_mem_zalloc_intern(ram_type, size, __func__, __LINE__)
 ...
 *
 */
#define os_mem_zalloc2(size) os_mem_zalloc_intern(RAM_TYPE_DATA_ON, size, __func__, __LINE__)
